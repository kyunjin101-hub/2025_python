...
person = Person("김윤진")
tk.Label(root,text="반려동물 등록하기",font=("bold")).pack(pady=8)
...
tk.Label(frm_main,textvariable=result_var,fg="blue",wraplength=500,justify="left").grid(row=3,column=0,columnspan=4,padx=15)
