...
class Book:
    ...
    def borrow(self):
        if not self.borrowed:
            ...
            print(f"{self.title}은 이미 대출 중입니다.")
    ...
    def return_book(self):
        if self.borrowed:
            ...
            print(f"{self.title}은 대출되지 않은 상태입니다.")
...
def borrow_book():
   ...
   for b in borrowed_books:
       if b.title == title and b.author == author:
           label_result.config(text=f"{title}은 이미 대출 중입니다.",fg="red")
           return
...
def return_book():
    ...
    for b in borrowed_books:
        if b.title == title and b.author == author:
            ...
            label_result.config(text=f"{title}이 반납되었습니다.", fg="red")
            return
    label_result.config(text=f"{title}은 대출 목록에 없습니다.", fg="red")
